...
def check_source_gds_consitency(target_path, toplevel, user_module, user_module_name, output_directory, top_type_list, top_name_list, user_type_list,
    ...
    try:
        ...
        return False, "Either you didn't mount the docker, or you ran out of RAM. Otherwise, magic is broken. Please check `checks/magic_extract.log` in the output directory for potentially more details."
    except OSError:
        return False, "Either you didn't mount the docker, or you ran out of RAM. Otherwise, magic is broken. Please check `checks/magic_extract.log` in the output directory for potentially more details."
