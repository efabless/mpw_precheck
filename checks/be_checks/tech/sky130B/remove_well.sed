...
s/[^ ]* \(ppolyf_u\)/\1/
s/[^ ]* \(.fet_06v0\)/\1/
/^[DX].* sky130_fd_pr__diode_pd2nw_/d
/^[DX].* sky130_fd_pr__diode_pw2nd_/d
/^[DX].* sky130_fd_pr__model__parasitic__diode_ps2dn/d
/^[DX].* diode_pd2nw_06v0/d
/^[DX].* diode_nd2ps_06v0/d
/^D.* np_6p0/d
/^D.* pn_6p0/d
/^[RX].* sky130_fd_pr__res_iso_pw/d
